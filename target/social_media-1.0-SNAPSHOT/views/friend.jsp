...
<body>
		...
		<form method="post" action="/social_media/friend">
			<tr>
				...
				<td><input type="hidden" name="username"
					...
					value="<%= limits %>"> <input type="submit" value="View"
					formaction="/social_media/profile?username=<%= username %>"
					formmethod="post"> <input type="submit" name="btnFriend"
					value="Delete"></td>
			</tr>
		</form>
		<%
	...
	<jsp:include page="../components/paginationFriend.jsp" />
