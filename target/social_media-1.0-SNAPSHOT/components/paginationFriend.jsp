...
<div style="display: flex; justify-content: center; align-content: center; gap: 2px">
    ...
    %>
            <a href="/social_media/friend?page=<%= currentPage -1 %>&limit=<%= perPage%>" style="background-color: yellowgreen; padding: 8px 12px; border-radius: 4px; text-decoration: none"><</a>           
    <%
        }
    %>
    <%   
    ...
    %>
            <a href="/social_media/friend?page=1&limit=<%= perPage%>" style="background-color: yellowgreen; padding: 8px 12px; border-radius: 4px; text-decoration: none">1</a>
    ...
    %>
            <a href="/social_media/friend?page=<%= i %>&limit=<%=perPage%>" style="background-color: yellowgreen; padding: 8px 12px; border-radius: 4px; text-decoration: none"><%= i %></a>
    <%
            }
    ...
    %>
            <div style="padding: 8px 12px">...</div>
            <a href="/social_media/friend?page=<%= totalPage%>&limit=<%= perPage%>" style="background-color: yellowgreen; padding: 8px 12px; border-radius: 4px; text-decoration: none"> <%= totalPage%></a>
    <%
        }
