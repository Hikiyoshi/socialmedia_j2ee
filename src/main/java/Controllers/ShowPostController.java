 ...
 * @author Admin
 */
@WebServlet(name="ShowPostController", urlPatterns={"/ShowPost"})
public class ShowPostController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        System.out.println(startNum + " " + username);
        List<Post> listPost = PostDAO.findByUsernamePages(username, startNum, 5);
